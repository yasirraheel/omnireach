...
class PricingPlanRequest extends FormRequest
{
    ...
    protected function prepareForValidation()
    {
        $this->merge([
            ...
            'lead_generation_enabled'   => $this->convertToBoolean($this->lead_generation_enabled),
            'automation_enabled'        => $this->convertToBoolean($this->automation_enabled),
        ]);
    }
    ...
    public function rules()
    {
        ...
        $rules['lead_generation_enabled'] = ['nullable', 'boolean'];
        $rules['lead_daily_limit'] = ['nullable', 'integer', 'min:-1'];
        $rules['lead_monthly_limit'] = ['nullable', 'integer', 'min:-1'];

        // Workflow Automation rules
        $rules['automation_enabled'] = ['nullable', 'boolean'];
        $rules['automation_workflow_limit'] = ['nullable', 'integer', 'min:-1'];
        $rules['automation_execution_limit'] = ['nullable', 'integer', 'min:-1'];
