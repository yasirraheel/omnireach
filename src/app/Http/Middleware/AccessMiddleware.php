            ...
            foreach ($routes as $route) {
                ...
                foreach ($associativeRoutes as $route_key => $route_name) {
                    ...
                    if ($allowed_access && stripos($current_route, $route_name) !== false) {
                        ...
                        $pass = true;
                    } elseif ((stripos($current_route, "gateway.sending-domain")) && $allowed_access["email"]["is_allowed"]) {

                        $pass = true;
                    } elseif ((stripos($current_route, "gateway.tracking-domain")) && $allowed_access["email"]["is_allowed"]) {
