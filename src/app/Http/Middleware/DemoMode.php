...
class DemoMode
{
    ...
    {
        // Routes allowed in demo mode (QR code generation for visitor testing)
        $allowedRoutes = [
            'admin/gateway/whatsapp/device/server/qr-code',
            'admin/gateway/whatsapp/device/server/status',
            'user/gateway/whatsapp/device/server/qr-code',
            'user/gateway/whatsapp/device/server/status',
        ];
        ...
        if (env('APP_MODE')=='demo') {
            // Allow QR code generation and status check in demo mode for visitor testing
