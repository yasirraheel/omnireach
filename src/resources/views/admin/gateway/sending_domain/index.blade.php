                                ...
                                <tr>
                                    ...
                                    <td data-label="{{ translate('Action')}}">
                                        <div class="d-flex align-items-center gap-2">
                                            @if(!$allVerified)
                                                <a href="{{ route('admin.gateway.sending-domain.dns', $domain->uid) }}" class="i-btn btn--primary btn--sm space-nowrap">
                                                    <i class="ri-settings-3-line"></i> {{ translate("Configure DNS") }}
                                                </a>
                                            @else
                                                <a href="{{ route('admin.gateway.sending-domain.dns', $domain->uid) }}" class="i-btn btn--success outline btn--sm space-nowrap">
                                            ...
                                            <button class="icon-btn btn-ghost btn-sm danger-soft circle text-danger delete-domain"
                                                    type="button"
                                                    data-url="{{ route('admin.gateway.sending-domain.delete', $domain->uid) }}"
...
<div class="modal fade" id="addDomain" tabindex="-1" aria-labelledby="addDomain" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form action="{{ route('admin.gateway.sending-domain.store') }}" method="POST">
                @csrf
...
<div class="modal fade actionModal" id="deleteDomain" tabindex="-1" aria-labelledby="deleteDomain" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form method="POST" id="deleteDomainForm">
                ...
                <div class="modal-body">
                    <div class="action-message">
                        ...
                        <p>{{ translate("DKIM signing will stop for emails from this domain. This action cannot be undone.") }}</p>
                    </div>
                </div>
                <div class="modal-footer">
