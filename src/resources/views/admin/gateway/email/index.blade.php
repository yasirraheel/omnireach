        ...
        function buildCredentialFields(container, credData, oldValues, isSmtp) {
            ...
            $.each(credData, function(key, v) {
                ...
                if (key === 'encryption') {
                    ...
                    // Bind auto-fill for encryption change
                    ...
                    // Auto-set driver to SMTP and hide it
                    var hidden = $('<input type="hidden" name="meta_data[' + key + ']" value="SMTP">');
                    container.append(hidden);
                } else if (key === 'password') {
                    var label = $('<label for="' + key + '" class="form-label text-capitalize">' + filterkey + ' <sup class="text--danger">*</sup></label>');
                    var inputGroup = $('<div class="input-group"></div>');
                    var input = $('<input type="password" class="form-control" id="' + key + '" name="meta_data[' + key + ']" placeholder="' + translate("Enter " + filterkey) + '" required>');
                    ...
                    var label = $('<label for="' + key + '" class="form-label text-capitalize">' + filterkey + ' <sup class="text--danger">*</sup></label>');
                    var input = $('<input type="number" min="1" max="65535" class="form-control" id="' + key + '" name="meta_data[' + key + ']" placeholder="' + translate("e.g., 465 or 587") + '" required>');
                    ...
                    var label = $('<label for="' + key + '" class="form-label text-capitalize">' + filterkey + ' <sup class="text--danger">*</sup></label>');
                    var input = $('<input type="text" class="form-control" id="' + key + '" name="meta_data[' + key + ']" placeholder="' + translate("Enter " + filterkey) + '" required>');
                    if (oldValues && oldValues[key]) input.val(oldValues[key]);
                    div.append(label, input);
                    container.append(div);
                }
