    ...
    <div class="container-fluid px-0 main-content">
        <div class="page-header">
            ...
            <div class="page-header-right">
                <a href="{{ route('admin.automation.show', $workflow->uid) }}" class="i-btn btn--dark outline btn--md">
    ...
    <div class="execution-header">
        <div class="row align-items-center">
            ...
            <div class="col-lg-4 text-lg-end mt-3 mt-lg-0">
                ...
                @endif
                <a href="{{ route('admin.automation.show', $workflow->uid) }}" class="btn btn-outline-secondary">
...
<script>
    function cancelExecution() {
        ...
        fetch('{{ route("admin.automation.execution.cancel", [$workflow->uid, $execution->uid]) }}', {
            method: 'POST',
            headers: {
