              ...
              <div class="form-tab">
                <ul class="nav" role="tablist">
                  <li class="nav-item" role="presentation">
                    <a class="nav-link {{ old('active_tab', 'singleAudience') == 'singleAudience' ? 'active' : '' }}" data-bs-toggle="tab" href="#singleAudience" role="tab" aria-selected="{{ old('active_tab', 'singleAudience') == 'singleAudience' ? 'true' : 'false' }}">
                      <i class="bi bi-person-fill"></i>{{ translate("Single audience") }} </a>
                  </li>
                  <li class="nav-item" role="presentation">
                    <a class="nav-link {{ old('active_tab') == 'groupAudience' ? 'active' : '' }}" data-bs-toggle="tab" href="#groupAudience" role="tab" aria-selected="{{ old('active_tab') == 'groupAudience' ? 'true' : 'false' }}">
                      <i class="bi bi-people-fill"></i> {{ translate("Group audience") }} </a>
                  </li>
                  <li class="nav-item" role="presentation">
                    <a class="nav-link {{ old('active_tab') == 'importFile' ? 'active' : '' }}" data-bs-toggle="tab" href="#importFile" role="tab" aria-selected="{{ old('active_tab') == 'importFile' ? 'true' : 'false' }}">
        ...
        <div class="card-body pt-0">
          <form action="{{route('admin.communication.sms.store', ['type' => 'sms'])}}" method="POST" enctype="multipart/form-data" id="sms_send">
            ...
            <div class="tab-content">
                  ...
                  <div class="form-element">
                      ...
                      <div class="col-xxl-7 col-lg-9">
                          <div class="form-inner">
                              ...
                              <input type="number" class="form-control" name="contacts" id="sms_contact" placeholder="{{ translate("Enter recipient contact number") }}" aria-label="sms_contact" autocomplete="" value="{{ old('active_tab') == 'singleAudience' ? old('contacts') : '' }}"/>
                          </div>
                      </div>
                      </div>
                  </div>
              ...
              <div class="tab-pane fade {{ old('active_tab') == 'groupAudience' ? 'show active' : '' }}" id="groupAudience" role="tabpanel">
                <div class="form-element">
                  <div class="row gy-3">
                    <div class="col-xxl-2 col-xl-3">
              ...
              <div class="tab-pane fade {{ old('active_tab') == 'importFile' ? 'show active' : '' }}" id="importFile" role="tabpanel">
                <div class="form-element">
                  <div class="row gy-3">
                    <div class="col-xxl-2 col-xl-3">
                      ...
                      <div class="col-12">
                        <div class="form-inner">
                          ...
                          <select class="form-select select2-search" id="chooseMethod" data-placeholder="{{ translate("Choose a sending method") }}" aria-label="chooseMethod" name="method">
                            <option value=""></option>
                            <option value="{{ \App\Enums\System\Gateway\SmsGatewayTypeEnum::ANDROID->value }}" {{ old('method') == \App\Enums\System\Gateway\SmsGatewayTypeEnum::ANDROID->value ? 'selected' : '' }}>{{ translate("Android") }}</option>
                            <option value="{{ \App\Enums\System\Gateway\SmsGatewayTypeEnum::API->value }}" {{ old('method') == \App\Enums\System\Gateway\SmsGatewayTypeEnum::API->value ? 'selected' : '' }}>{{ translate("API") }}</option>
                          </select>
                        </div>
                      </div>
                ...
                <div class="col-xxl-7 col-lg-9">
                  <div class="radio-buttons-container message-type">
                    <div class="radio-button">
                      <input class="radio-button-input" type="radio" name="sms_type" id="smsTypeText" value="plain" {{ old('sms_type', 'plain') == 'plain' ? 'checked' : '' }} />
                      <label for="smsTypeText" class="radio-button-label">
                        <span class="radio-button-custom"></span> {{ translate("Plain") }} </label>
                    </div>
                    <div class="radio-button">
                      <input class="radio-button-input" type="radio" name="sms_type" id="smsTypeUnicode" value="unicode" {{ old('sms_type') == 'unicode' ? 'checked' : '' }} />
