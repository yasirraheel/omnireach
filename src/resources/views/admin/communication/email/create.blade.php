...
@php
    ...
    $emailPreferences = session('admin_email_dispatch_preferences', []);
              ...
              <div class="row gy-3">
                ...
                <div class="col-xxl-7 col-lg-9">
                  <div class="form-inner">
                    ...
                    <div class="input-group">
                      <input type="datetime-local" class="form-control singleDateTimePicker singleDate" placeholder="{{ translate("Select schedule time") }}" name="schedule_at" id="schedule_at" value="{{ old('schedule_at') }}"/>
            ...
            <div class="form-element">
              <div class="row gy-3">
                ...
                <div class="form-inner position-relative speech-to-text" id="messageBox">
                  ...
                  <textarea class="form-control" name="message[main_body]" id="message" rows="5" placeholder="{{translate('Enter email content')}}"\nIf Contact is being selected from a group then to mention First Name Use {{". 'first_name' ."}} \nTo initiate text spinner type {Hello|Hi|Hola} to you, {Mr.|Mrs.|Ms.} {Lucia|Jimmy|Arnold}"@endphp">{{ old('message.main_body') }}</textarea>
                ...
                @endif
                @include('partials.email_attachments')
                </div>
...
<script>
    ...
    $(document).ready(function() {
      ...
      const emailPreferenceKey = 'admin_email_dispatch_preferences';
      ...
      $singleEmailGroups.on('change', function() {
          ...
          $.ajax({
              url: '{{ route("admin.contact.group.fetch", ["type" => "email_contacts"]) }}',
              type: 'POST',
              data: {
