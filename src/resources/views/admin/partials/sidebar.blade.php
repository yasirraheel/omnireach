@php
    ...
    $isSettingActive            = ['admin.system.*', 'admin.whatsapp.*'];
    ...
    $isLeadGenerationActive     = ['admin.lead-generation.*'];
    $isAutomationActive         = ['admin.automation.*'];
    $isCampaignActive           = ['admin.campaign.*'];
    $isCampaignIntelligenceActive = ['admin.campaign.intelligence.*'];
    $isWhatsappCloudApiActive   = ['admin.whatsapp.*'];
                            ...
                            <div class="sidebar-menu-container">
                                <ul class="sidebar-menu">
                                    ...
                                    <li class="sidebar-menu-item">
                                        ...
                                        <div class="side-menu-dropdown collapse {{menuShow(array_merge(['admin.communication.whatsapp.chats.index', 'admin.communication.whatsapp.create', 'admin.communication.whatsapp.index'], $isWhatsappCampaignActive))}}" id="whatsappCommunication">
                                            <ul class="sub-menu">
                                                <li class="sub-menu-item">
                                                    <a class="sidebar-menu-link {{request()->routeIs('admin.communication.whatsapp.chats.index') ? 'active' :''}}" href="{{ route('admin.communication.whatsapp.chats.index') }}">
                                                        <p>{{ translate("Chats") }}</p>
                                                    </a>
                                                </li>
                                                <li class="sub-menu-item">
                    ...
                    <div class="sub-menu-wrapper {{menuShow($isLeadGenerationActive)}}" {{ menuShow($isLeadGenerationActive) == 'show' ? "style='opacity:1;visibility:visible;'" : '' }}>
                        <div class="sub-menu-container">
                            ...
                            <div class="sidebar-menu-container">
                                <ul class="sidebar-menu">
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-link {{ request()->routeis('admin.lead-generation.index') ? 'active' : '' }}" href="{{ route('admin.lead-generation.index') }}" aria-expanded="false">
                                            <span>
                                    ...
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-link {{ request()->routeis('admin.lead-generation.scraper') && request()->route('type') == 'google_maps' ? 'active' : '' }}" href="{{ route('admin.lead-generation.scraper', 'google_maps') }}" aria-expanded="false">
                                            <span>
                                    ...
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-link {{ request()->routeis('admin.lead-generation.scraper') && request()->route('type') == 'website' ? 'active' : '' }}" href="{{ route('admin.lead-generation.scraper', 'website') }}" aria-expanded="false">
                                            <span>
                                    ...
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-link {{ request()->routeis('admin.lead-generation.settings') ? 'active' : '' }}" href="{{ route('admin.lead-generation.settings') }}" aria-expanded="false">
                                            <span>
                                    ...
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-link {{ request()->routeis('admin.lead-generation.leads') ? 'active' : '' }}" href="{{ route('admin.lead-generation.leads') }}" aria-expanded="false">
                                            <span>
                                    ...
                                    <li class="sidebar-menu-note">
                                        <p class="menu-note">
                                            {{ translate("Scrape business contacts") }}
                                            <br>
                                            {{ translate("from Google Maps & websites") }}
                                        </p>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="sub-menu-wrapper {{menuShow($isCampaignActive)}}" {{ menuShow($isCampaignActive) == 'show' ? "style='opacity:1;visibility:visible;'" : '' }}>
                        <div class="sub-menu-container">
                            ...
                            <div class="sidebar-menu-container">
                                <ul class="sidebar-menu">
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-link {{ request()->routeis('admin.campaign.index') ? 'active' : '' }}" href="{{ route('admin.campaign.index') }}">
                                            <span>
                                    ...
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-link {{ request()->routeis('admin.campaign.create') ? 'active' : '' }}" href="{{ route('admin.campaign.create') }}">
                                            <span>
                                    ...
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-link {{ request()->routeis('admin.campaign.intelligence.insights.index') || request()->routeis('admin.campaign.intelligence.insights.show') ? 'active' : '' }}" href="{{ route('admin.campaign.intelligence.insights.index') }}">
                                            <span>
                                    ...
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-link {{ request()->routeis('admin.campaign.intelligence.ab-test.*') ? 'active' : '' }}" href="{{ route('admin.campaign.intelligence.ab-test.index') }}">
                                            <span>
                                    ...
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-link {{ request()->routeis('admin.campaign.intelligence.insights.send-time') || request()->routeis('admin.campaign.intelligence.insights.compare') ? 'active' : '' }}" href="{{ route('admin.campaign.intelligence.insights.send-time') }}">
                                            <span>
                    ...
                    <div class="sub-menu-wrapper {{menuShow($isAutomationActive)}}" {{ menuShow($isAutomationActive) == 'show' ? "style='opacity:1;visibility:visible;'" : '' }}>
                        <div class="sub-menu-container">
                            ...
                            <div class="sidebar-menu-container">
                                <ul class="sidebar-menu">
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-link {{ request()->routeis('admin.automation.index') ? 'active' : '' }}" href="{{ route('admin.automation.index') }}" aria-expanded="false">
                                            <span>
                                                <i class="ri-dashboard-line"></i>
                                            </span>
                                    ...
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-link {{ request()->routeis('admin.automation.create') ? 'active' : '' }}" href="{{ route('admin.automation.create') }}" aria-expanded="false">
                                            <span>
                                                <i class="ri-add-circle-line"></i>
                                            </span>
                        ...
                        <div class="sub-menu-container">
                            ...
                            <div class="sidebar-menu-container">
                                <ul class="sidebar-menu">
                                    ...
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-link {{ request()->type == "theme" ? 'active' : '' }}" 
                                            href="{{ route("admin.system.setting", ["type" => "theme"]) }}">
                                            <span>
                                                <i class="ri-paint-brush-line"></i>
                                            </span>
                                            <p>{{ translate("Theme Base") }}</p>
                                        </a>
                                    </li>
                                    <li class="sidebar-menu-item">
                                    ...
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-link {{ request()->routeIs('admin.system.settings.plan-features.*') ? 'active' : '' }}" href="{{ route("admin.system.settings.plan-features.index") }}">
                                            <span>
                                                <i class="ri-price-tag-3-line"></i>
                                            </span>
                                            <p>{{ translate("Plan Features") }}</p>
                                        </a>
                                    </li>
                                    ...
                                    @php
                                        $isWhatsappCloudActive = request()->routeIs('admin.whatsapp.*') || request()->type == "meta_configurations";
                                    @endphp
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-link {{ !$isWhatsappCloudActive ? 'collapsed' : '' }}" data-bs-toggle="collapse" href="#whatsappCloudApiMenu" role="button" aria-expanded="{{ $isWhatsappCloudActive ? 'true' : 'false' }}" aria-controls="whatsappCloudApiMenu">
                                            <span>
                                                <i class="ri-whatsapp-line"></i>
                                            </span>
                                            <p> {{ translate("WhatsApp Cloud API") }} <small> <i class="ri-arrow-down-s-line"></i> </small>
                                            </p>
                                        </a>

                                        <div class="side-menu-dropdown collapse {{ $isWhatsappCloudActive ? 'show' : '' }}" id="whatsappCloudApiMenu">
                                            <ul class="sub-menu">
                                                <li class="sub-menu-item">
                                                    <a class="sidebar-menu-link {{ request()->type == "meta_configurations" ? 'active' : '' }}" href="{{ route("admin.system.setting", ["type" => "meta_configurations"]) }}">
                                                        <p>{{ translate("Legacy Settings") }}</p>
                                                    </a>
                                                </li>
                                                <li class="sub-menu-item">
                                                    <a class="sidebar-menu-link {{ request()->routeIs('admin.whatsapp.configuration.*') ? 'active' : '' }}" href="{{ route('admin.whatsapp.configuration.index') }}">
                                                        <p>{{ translate("Configurations") }}</p>
                                                    </a>
                                                </li>
                                                <li class="sub-menu-item">
                                                    <a class="sidebar-menu-link {{ request()->routeIs('admin.whatsapp.health.*') ? 'active' : '' }}" href="{{ route('admin.whatsapp.health.index') }}">
                                                        <p>{{ translate("Health Monitor") }}</p>
                                                    </a>
                                                </li>
                                                <li class="sub-menu-item">
                                                    <a class="sidebar-menu-link {{ request()->routeIs('admin.whatsapp.onboarding.*') ? 'active' : '' }}" href="{{ route('admin.whatsapp.onboarding.index') }}">
                                                        <p>{{ translate("Client Onboarding") }}</p>
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    {{-- <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-link {{ menuActive(['admin.system.addon.manager.*']) }}" href='{{route("admin.system.addon.manager.index")}}'>
                                            <span>
                                                <i class="ri-puzzle-line"></i>
                                            </span>
                                            <p>{{ translate("Addon Manager") }}</p>
                                        </a>
                                    </li> --}}
                                    <li class="sidebar-menu-item">
