    ...
    <div class="container-fluid px-0 main-content">
                ...
                <div class="breadcrumb-wrapper">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{ translate('Intelligence') }}</li>
                        </ol>
                    </nav>
                </div>
            </div>
            <div class="page-header-right">
                <a href="{{ route('admin.campaign.intelligence.insights.send-time') }}" class="i-btn btn--dark outline btn--md">
                    <i class="ri-time-line"></i> {{ translate('Send Time Analysis') }}
                </a>
                <a href="{{ route('admin.campaign.intelligence.insights.compare') }}" class="i-btn btn--primary btn--md">
        ...
        <div class="intelligence-stats-grid mb-4">
            ...
            <div class="intelligence-stat-card stat-success">
                ...
                <div class="intelligence-stat-content">
                    <h3>{{ number_format($completedCampaigns) }}</h3>
            ...
            <div class="intelligence-stat-card stat-info">
                ...
                <div class="intelligence-stat-content">
                    ...
                    <p>{{ translate('Contacts Analyzed') }}</p>
                </div>
            </div>
            <div class="intelligence-stat-card stat-warning">
                ...
                <div class="intelligence-stat-content">
                    <h3>{{ number_format($avgEngagement, 1) }}%</h3>
                    <p>{{ translate('Avg. Engagement') }}</p>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-8">
                <div class="card h-100">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('admin.campaign.index') }}" class="i-btn btn--primary-outline btn--sm">
                            {{ translate('View All') }} <i class="ri-arrow-right-line ms-1"></i>
                        </a>
                    </div>
                                ...
                                <tbody>
                                    @foreach($campaigns as $campaign)
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <a href="{{ route('admin.campaign.intelligence.insights.show', $campaign->id) }}"
        ...
        <div class="feature-cards-grid">
            <div class="feature-card">
                ...
                <a href="{{ route('admin.campaign.intelligence.ab-test.index') }}" class="i-btn btn--primary btn--md">
            ...
            <div class="feature-card">
                ...
                <a href="{{ route('admin.campaign.intelligence.insights.send-time') }}" class="i-btn btn--info btn--md">
            ...
            <div class="feature-card">
                ...
                <h5>{{ translate('Content Optimizer') }}</h5>
                <p>{{ translate('Get AI-powered suggestions to improve your message deliverability') }}</p>
                <a href="{{ route('admin.campaign.create') }}" class="i-btn btn--warning btn--md">
                    {{ translate('Create Campaign') }} <i class="ri-arrow-right-line ms-1"></i>
                </a>
            </div>
        </div>
