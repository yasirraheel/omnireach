                            ...
                            @forelse($currencies as $currency_code => $currency_value)
                                ...
                                <tr class="@if($loop->even)@endif">
                                    ...
                                    <td data-label="{{ translate('Rate')}}">
                                        {{translate("1 ").getDefaultCurrencyCode(json_decode(site_settings('currencies'), true))}} = {{shortAmount($currency_value['rate'], 3)}} {{$currency_code}}
                                    </td>
...
<div class="modal fade" id="updateCurrency" tabindex="-1" aria-labelledby="updateCurrency" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered ">
        <div class="modal-content">
            <form action="{{route('admin.system.currency.update')}}" method="POST">
                @csrf
                    ...
                    <div class="row g-4">
                        <div class="col-lg-6">
                            <div class="form-inner">
                                ...
                                <input disabled type="text" name="code" id="code" placeholder="{{ translate('Enter Currency Code')}}" class="form-control" aria-label="code"/>
                                <input hidden type="text" id="code" name="code" placeholder="{{ translate('Enter Currency Code')}}" class="form-control" aria-label="code"/>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-inner">
...
<div class="modal modal-select2 fade" id="addCurrency" tabindex="-1" aria-labelledby="addCurrency" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered ">
        <div class="modal-content">
            <form action="{{route('admin.system.currency.store')}}" method="POST">
                @csrf
                <div class="modal-header">
