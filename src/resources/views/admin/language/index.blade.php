                        ...
                        <div class="col-md-12">
                            <div class="form-inner">
                              ...
                              <div class="form-inner-switch">
                                <label class="pointer" for="ltr" >{{ translate("Is the language RTL compatible? ") }}</label>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-12">
                            <div class="form-inner">
                              <label class="form-label"> {{ translate("LTR/RTL Compatibility") }} </label>
                              <div class="form-inner-switch">
                                <label class="pointer" for="update_ltr" >{{ translate("Is the language RTL compatible? ") }}</label>
                                <div class="switch-wrapper mb-1 checkbox-data">
...
<script>
	"use strict";
		...
		$('.update-language').on('click', function() {
            ...
            if($(this).data('language-ltr') == {{ \App\Enums\StatusEnum::FALSE->status() }}) {
