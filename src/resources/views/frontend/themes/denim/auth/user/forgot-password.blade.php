          ...
          <div class="col-lg-6 order-lg-1 order-0">
            <div class="auth-right">
              ...
              <div class="auth-form-wrapper">
                ...
                <form action="{{route('password.email')}}" method="POST" id="forgot-password-form" class="auth-form">
                    @csrf
                    ...
                    <button class="i-btn btn--primary bg--gradient btn--xl rounded-3 w-100 mt-2" type="submit" id="submit-btn">
                        {{ translate("Send Code") }} 
