        ...
        <div class="page-header">
            ...
            <div class="page-header-right">
                <div class="d-flex gap-2">
                    ...
                    <a href="{{ route('user.campaign.intelligence.insights.index') }}" class="i-btn btn--primary btn--md">
            ...
            <div class="card-body">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4 text-lg-end mt-3 mt-lg-0">
                        @if($insight && $insight->trend_direction == 'improving')
                            <span class="trend-badge improving">
                                <i class="ri-arrow-up-line"></i>{{ translate('Performance Improving') }}
                            </span>
                        @elseif($insight && $insight->trend_direction == 'declining')
                ...
                <div class="row g-4">
                    <div class="col-md-3 col-6">
                        <div class="summary-stat">
                            <div class="summary-value">{{ number_format($summary['total_contacts'] ?? $campaign->total_contacts ?? 0) }}</div>
                            <div class="summary-label">{{ translate('Total Contacts') }}</div>
                        </div>
                    </div>
                    <div class="col-md-3 col-6">
                        <div class="summary-stat">
                            <div class="summary-value" style="color: var(--color-primary)">{{ number_format($summary['processed'] ?? $campaign->processed_contacts ?? 0) }}</div>
...
(function($) {
    ...
    $('#refreshInsights').on('click', function() {
        ...
        $.post('{{ route("user.campaign.intelligence.insights.refresh", $campaign->id) }}', {
            _token: '{{ csrf_token() }}'
        })
        .done(function() {
            location.reload();
