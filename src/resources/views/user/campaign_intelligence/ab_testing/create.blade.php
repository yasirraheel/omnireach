                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">
                            <i class="ri-flask-line me-2"></i>{{ translate('Test Configuration') }}
                        </h4>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('user.campaign.intelligence.ab-test.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-12">
                                    ...
                                    <small class="text-muted">{{ translate('Only draft or scheduled campaigns can have A/B tests') }}</small>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <small class="text-muted">{{ translate('Percentage of contacts to use for testing (5-50%)') }}</small>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <small class="text-muted">{{ translate('How long to run the test before selecting winner') }}</small>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <small class="text-muted">{{ translate('Metric used to determine the winning variant') }}</small>
                                </div>
            ...
            <div class="col-lg-4">
                <div class="help-card mb-4">
                    ...
                    <div class="d-flex gap-3 mb-3">
                        ...
                        <div>
                            <strong>{{ translate('Create Variants') }}</strong>
                    ...
                    <div class="d-flex gap-3 mb-3">
                        ...
                        <div>
                            <strong>{{ translate('Split Audience') }}</strong>
                    ...
                    <div class="d-flex gap-3 mb-3">
                        ...
                        <div>
                            <strong>{{ translate('Measure Results') }}</strong>
                    ...
                    <div class="d-flex gap-3">
                        ...
                        <div>
                            <strong>{{ translate('Select Winner') }}</strong>
