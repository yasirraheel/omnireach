...
<main class="main-body">
    <div class="container-fluid px-0 main-content">
        ...
        <form action="{{ route('user.campaign.store') }}" method="POST" id="campaignForm">
            @csrf
            ...
            <div class="row g-4">
                <div class="col-xl-8">
                                            ...
                                            <div class="col-md-12 recurring-section" style="display: none; margin-top: 1rem;">
                                                <div class="form-inner">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="number" name="repeat_time" id="repeat_time" class="form-control" placeholder="{{ translate("Amount of times you want this campaign to repeat") }}" min="1" value="{{ old('repeat_time', 1) }}"/>
                                                        <select id="repeat_format" class="form-select" name="repeat_format">
                                                            ...
                                                            @foreach(App\Enums\System\RepeatTimeEnum::getValues() as $value)
                                                                @if($value !== 'none')
                                                                    <option value="{{ $value }}" {{ old('repeat_format', 'daily') == $value ? 'selected' : '' }}>{{ ucfirst($value) }}</option>
                                                                @endif
                                                            @endforeach
                                                        </select>
                                                    </div>
                    ...
                    <div class="d-flex justify-content-end gap-3 mt-4">
                        <a href="{{ route('user.campaign.index') }}" class="i-btn btn--dark outline btn--md">{{ translate('Cancel') }}</a>
