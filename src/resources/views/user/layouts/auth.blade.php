...
<head>
    ...
    <link rel="stylesheet" href="{{versioned_asset('assets/theme/frontend/css/bootstrap.min.css')}}" />
    <link rel="stylesheet" href="{{versioned_asset('assets/theme/frontend/css/bootstrap-icons.min.css')}}" />
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.css" />
    <link rel="stylesheet" href="{{versioned_asset('assets/theme/frontend/css/dimbox.min.css')}}" />
    <link rel="stylesheet" href="{{versioned_asset('assets/theme/frontend/css/main.css')}}" />
    <link rel="stylesheet" href="{{versioned_asset('assets/theme/frontend/css/font-awesome.css')}}" />
    <link rel="stylesheet" type="text/css" href="{{versioned_asset('assets/theme/admin/css/iconpicker/fontawesome-iconpicker.css')}}">
    <link rel="stylesheet" href="{{versioned_asset('assets/theme/global/css/font_bootstrap-icons.css')}}">
...
<body>
    ...
    <script src="{{versioned_asset('assets/theme/frontend/js/bootstrap.bundle.min.js')}}"></script>
    <script src="https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.js"></script>
    <script src="{{versioned_asset('assets/theme/frontend/js/dimbox.min.js')}}"></script>
    <script src="{{versioned_asset('assets/theme/global/js/helper.js')}}"></script>
    <script src="{{versioned_asset('assets/theme/admin/js/iconpicker/fontawesome-iconpicker.js')}}"></script>
    <script src="{{versioned_asset('assets/theme/frontend/js/app.js')}}"></script>
